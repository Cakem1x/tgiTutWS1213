...
\end{itemize}
%\end{block}
%Eine universelle Turingmaschine ist eine Turingmaschine, mit der jegliche Turingmaschine simuliert werden kann. Sie erhält als Eingabe die Gödelnummer der zu simulierenden Turingmaschine und die zu bearbeitende Eingabe.
\end{frame}
