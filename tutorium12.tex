...
Damit ergibt sich der Zusammenhang \[P(R=r)=\sum_{r} P(Q=q)P(R=r|Q=q)\] und für die Wahrscheinlichkeit das r und q gleichzeitig auftreten: \[P(Q=q,R=r)=P(Q=q)P(R=r|Q=q).\]
\end{frame}
\begin{frame}
...
\[H(Q,R)=-\sum_{q} \sum_{r} P(Q=q,R=r)\log(P(Q=q,R=r))\]
